...
с помощью метода print, затем сортируем элементы в обратном порядке с помощью лямбда-выражения в методе sort и снова 
...
public class Program {
    public static void main(String[] args) {
        DataContainer<String> dc = new DataContainer<String>();
        dc.add("bbb");
        dc.add("aaa");
        dc.add("ccc");
        dc.print();
        dc.sort((s1, s2) -> -s1.compareTo(s2));
        dc.print();
    }
}
